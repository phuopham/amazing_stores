...
const SizeForm = ({ initialData }: SizeFormProps) => {
    ...
    const description = initialData ? "Modify size" : "Add a new size"
    const toastMsg = initialData ? "Size updated successfully." : "Size created successfully."
    ...
    const onConfirmDelete = async () => {
        try {
            ...
            toast.error('Cannot delete size by now!!!!')
        } finally {
            setLoading(false)
        }
    }
