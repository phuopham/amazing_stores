...
const ProductForm = ({ initialData, categories, colors, sizes }: ProductFormProps) => {
    ...
    const description = initialData ? "Modify product" : "Add a new product"
    const toastMsg = initialData ? "Product updated successfully." : "Product created successfully."
    ...
    const onConfirmDelete = async () => {
        try {
            ...
            toast.error('Cannot delete Product by now!!!!')
        } finally {
            setLoading(false)
        }
    }
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <ImageUpload
                                    ...
                                    onRemove={(url) => field.onChange([...field.value.filter((it) => it.url !== url)])}
